...
# carga de datos
supertienda_raw = pd.read_csv('Muestra - Supertienda.csv')
...
supertienda_raw['Fecha del pedido'] = pd.to_datetime(supertienda_raw['Fecha_pedido'])
